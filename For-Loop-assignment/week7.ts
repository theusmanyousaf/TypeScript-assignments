...
let newArray:number[] = [];     /* Assuming I would store them in a new array */
...
let array2:number[]= [1,2,4,3,4,5,6,6,7,8,9,10];
...
let listOfGrades:number[]= [60,42,39,73,49,50,86,77,34,59,90];

for(let i= listOfGrades.length; i > 0 ; i--){
...
let arrayOfnumbers:number[] = [10,13,123,90,40,44,32,22,34,100,20];

function largestNumberFinder(arr:number[]): number {
