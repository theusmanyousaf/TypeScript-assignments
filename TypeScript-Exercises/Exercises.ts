...
let test21Str1: string = "Hello World!";

let test21Str2: string = "hello world!";
...
let val_1: number = Math.ceil(4 * 3.1);
let val_2: number = Math.floor(4 * 3.1);
...
let array_1 = ["Apples", "Peanuts", "Bananas", "Beef"];
...
function findItem2(item: string, arr: string[]) {
...
let favorite_fruits: string[] = ["pomegranates", "grapes", "oranges"];
...
let usernames: string[] = ["admin", "usman", "osaf", "ahmad", "mohsin"];
...
if (userList.length === 0) {
    ...
    for (let i = 0; i < userList.length; i++) {
        if (userList[i] === "admin") {
            console.log(`Hello ${userList[i]}, would you like to see a status report?`);
        } else {
...
let current_users: string[] = ["usman", "osaf", "omar", "ahmad", "amir"];

let new_users: string[] = ["basit", "usman", "fahad", "huzaifa", "ahmad"];
...
let Pizzas: string[] = ["BBQ-chicken", "malai-boti", "peparoni"];
...
let animals_list: string[] = ["Dog", "Cat", "Rabbits"];
...
function make_shirt(size: string, message: string) {
    console.log(`The size of the shirt is ${size} and the message on the shirt says:\n ${message}`);
}
...
function city_country(city: string = "Faisalabad", countary: string = "Pakistan"){
...
let dictionary_1 = make_album("Justin", "Believe");
console.log(dictionary_1);

let dictionary_2 = make_album("Jhon", "Purpose");
console.log(dictionary_2);

let dictionary_3 = make_album("M2four", "Generations");
console.log(dictionary_3);

let new_dictionary = make_album("Orion", "Faded", 12);
...
let magician_names: string[] = ["Kelly", "Tony", "Harry", "Jena"];
...
let magician_names2: string[] = ["Kelly", "Tony", "Harry", "Jena"];

function show_magicians2(arr: string[]){
    arr.forEach((val)=>console.log(val)
    );
}
...
let magician_names3: string[] = ["Kelly", "Tony", "Harry", "Jena"];

function show_magicians3(arr: string[]){
    arr.forEach((val)=>console.log(val)
    );
}

function make_great2(arr: string[]){
    let new_arr  = [];
    for (let i = 0; i < arr.length; i++) {
        new_arr.push(`the Great ${arr[i]}`);      
    }
    return new_arr;
}

let seperate_array: string[] = make_great2(magician_names3);
...
function sandwichMaker(arr: string[]){
...
function carMaker(manufacturer: string, model: string, car_type?: string, car_color?: string) {
    let car = {
        brand: manufacturer,
        name: model,
        type: car_type,
...
let newCar = carMaker("Audi", "R8 coupe", "sports", "Daytona Gray")
console.log(newCar);
